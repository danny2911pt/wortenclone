    ...
    <h1>Adicionar Produto</h1>
      <hr>
        ...
        <form class="form-horizontal" role="form">
          ...
          <option></option>
          <option>Vibradores</option>
          <option>Aneis</option>
          <option>Strap On</option>
...
<form class="form-horizontal" role="form">
         ...
         <input type="checkbox" value="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="button" class="btn btn-success" value="Adicionar">
              <span></span>
              <input type="button" onclick="window.location='http://localhost/wortas/editaprodutos.php';" class="btn btn-default" value="Retroceder" >
            </div>
          </div>
        </form>
      </div>
