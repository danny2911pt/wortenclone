                    ...
                    <thead style="background-color:#a12431; color: white;">
                       ...
                       <tbody>
                           <?php
                               ...
                               $query = mysqli_query($conn, "select utilizadores.u_nome, (tb_cartitens.preco*tb_cartitens.qta) as 'valor', tb_cart.id
                ...
                <table id="mytable" class="table table-bordered table-hover ">
                    <thead style="background:#a12431; color: white">
                       ...
                       <tbody>
                           <?php
                           include "connections/conn.php";
                           $query = mysqli_query($conn, "select utilizadores.u_nome, (tb_cartitens.preco*tb_cartitens.qta) as 'valor', tb_cart.id, pendente
                                                              from tb_cartitens join tb_cart on tb_cart.cart_id = tb_cartitens.cart_id
                                                              join utilizadores on utilizadores.id_utilizador = tb_cart.id_login
                                                              where pendente != 1");
                           include "connections/deconn.php";
