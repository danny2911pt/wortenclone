	...
	<div class="row">
        <div class="col-md-12">
            <?php
                ...
                $total = mysqli_fetch_array(mysqli_query($conn, "SELECT sum(tb_cartitens.preco*tb_cartitens.qta) from tb_cartitens"));
                        ...
                        <?php
                            ...
                            while ($array1 = mysqli_fetch_array($query))
                            {
                                $query2 = mysqli_query($conn, "SELECT SUM(tb_cartitens.preco*tb_cartitens.qta) as 'soma' 
                                                                 ...
                                                                 where utilizadores.id_login = $array1[id_login]");
