...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/java" href="js/edita.js">
...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
    <table class="table table-bordered">
      ...
      <thead style="background:#a12431; color:white;">
      <h3 style="text-align:center;">Rank Produtos(Compras)</h3>
        <tr>
          <th>#</th>
          <th>ID</th>
          <th>Produto</th>
