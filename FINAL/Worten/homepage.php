...
<?php
    ...
    $imagens = ["lanterna", "list", "invoice", "diagram"];
        ...
        <div class="sidebar" style="vertical-align: top">
            <a href="#basico" style="text-decoration: none; color: white">
                <div class="categoria home">
                    <img src="imagens/podium.png" alt="casa" style="vertical-align: middle; filter: invert(100%); width: 50%; text-align: center">
                    <h2>Ranking Produtos</h2>
                </div>
            </a>
